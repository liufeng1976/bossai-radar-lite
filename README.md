...
| GET | `/api/report/latest.md` | 下载最新 Markdown 日报 |
...
- 定时扫描时间计算；
- TypeScript 生产构建；
- 页面、API 与 Markdown 日报冒烟测试。

详细变更见 [CHANGELOG.md](CHANGELOG.md)，本版发布文案见 [docs/RELEASE_NOTES_v0.2.0.md](docs/RELEASE_NOTES_v0.2.0.md)。
